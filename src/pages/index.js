      ...
      <MDBRow>
        <MDBCol md="7" className="text-right">
          ...
          <p>
            ...
            klientów pozyskała około 480 mln zł dotacji na blisko 180 projektów
            inwestycyjnych
          </p>
        </MDBCol>
        <MDBCol
        ...
        <MDBCol md="7" className="text-right">
          <ul className="list-unstyled">
            <li className="mb-3">
              ...
              <br></br>
              Studia wykonalności inwestycji, biznes plany, wnioski aplikacyjne,
        ...
        <MDBCol md="7" className="text-right">
          <ul className="list-unstyled">
            <li className="mb-3">
              ...
              <br></br>Analiza rynku, tworzenie koncepcji usług, przygotowanie:
              umów, ofert, narzędzi zapewniających efektywność pracy
            </li>
            <li className="mb-3">
        ...
        <MDBCol md="7" className="text-righ">
          ...
          <ul className="list-unstyled">
            ...
            <li className="mb-3">
              ...
              <br></br> V Liceum Ogólnokształcące im. A. Witkowskiego w Krakowie
            </li>
          </ul>
        </MDBCol>
        <MDBCol
